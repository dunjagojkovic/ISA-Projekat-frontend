...
@Component({
  selector: 'app-settings-boat-owner',
  templateUrl: './settings-boat-owner.component.html',
  styleUrls: ['./settings-boat-owner.component.css']
})
export class SettingsBoatOwnerComponent implements OnInit {
